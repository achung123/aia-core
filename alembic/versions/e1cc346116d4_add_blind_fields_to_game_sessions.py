...
def upgrade() -> None:
    ...
    with op.batch_alter_table('game_sessions', schema=None) as batch_op:
        batch_op.add_column(sa.Column('small_blind', sa.Float(), nullable=False, server_default='0.1'))
        batch_op.add_column(sa.Column('big_blind', sa.Float(), nullable=False, server_default='0.2'))
        batch_op.add_column(sa.Column('blind_timer_minutes', sa.Integer(), nullable=False, server_default='15'))
        batch_op.add_column(sa.Column('blind_timer_paused', sa.Boolean(), nullable=False, server_default=sa.text('0')))
        batch_op.add_column(sa.Column('blind_timer_started_at', sa.DateTime(), nullable=True))
