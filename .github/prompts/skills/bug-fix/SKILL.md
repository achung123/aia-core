---
name: bug-fix
description: Reproduce, fix, and close a bug with a regression test and a beads-linked record. Use when a bug is reported or a claimed beads bug task needs to be resolved.
---
...
- A review surfaced a defect rather than a design concern
...
3. **Root-cause.** Trace the defect to the minimum code responsible. Note the root cause for the report.
