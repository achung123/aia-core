...
description: Shared skill — land the plane at the end of a work session (quality gates → beads sync → git push) per the AGENTS.md contract.
---
...
- The canonical contract is in [AGENTS.md](AGENTS.md) under "Landing the Plane"
...
8. **Hand off.** Produce the session report (below) so the next session has full context.
