---
name: db-migration
description: Generate, review, and validate an Alembic migration for any SQLAlchemy model change in aia-core. Use when adding, removing, renaming, or retyping tables, columns, indexes, or constraints.
---
...
6. **If tests reference the new column/table**, follow the `tdd-cycle` skill to add coverage for the new behavior.
