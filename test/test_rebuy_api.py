...
class TestGetRebuys:
    def test_get_rebuys_returns_ordered_list(self, client):
        ...
        client.post(f'/games/{game_id}/players/Alice/rebuys', json={'amount': 30.0})
        client.post(f'/games/{game_id}/players/Alice/rebuys', json={'amount': 50.0})
        client.post(f'/games/{game_id}/players/Alice/rebuys', json={'amount': 20.0})
...
class TestGameSessionResponseRebuyFields:
    def test_player_info_includes_rebuy_stats(self, client):
        ...
        # Create two rebuys
        client.post(f'/games/{game_id}/players/Alice/rebuys', json={'amount': 50.0})
        client.post(f'/games/{game_id}/players/Alice/rebuys', json={'amount': 75.0})
